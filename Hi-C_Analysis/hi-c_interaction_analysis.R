...
# Here ASD_ID_DD has too much values that made the R session crash; as a result the dataset split into sub-groups and run separately.
...
# Here ID_DD has too much values that made the R session crash; as a result the dataset split into sub-groups and run separately.
...
##HAVE PROBLEMS TO CAUSE RSESSION QUIT
# Separate ID_DD group into columns 
