...
# Same preprocessing procedure for pathway heatmap 
pathway_prep <- pathway
pathway_prep[is.na(pathway_prep)] = 1
pathway_prep$ASD[pathway_prep$ASD<0.0000009537] = 0.0000006743 # Set up -log2 max values to 25
pathway_prep$ASD_ID_DD[pathway_prep$ASD_ID_DD<0.0000009537] = 0.0000006743 # Set up -log2 max values to 25
pathway_prep$ID_DD[pathway_prep$ID_DD<0.0000009537] = 0.0000006743 # Set up -log2 max values to 25
pathway_prep$SCZ[pathway_prep$SCZ<0.0000009537] = 0.0000006743 # Set up -log2 max values to 25
